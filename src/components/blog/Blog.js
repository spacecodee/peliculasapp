    ...
    return (
        <div className="col-md-9 col-sm-12 col-xs-12">
            <div className="blog-detail-ct">
                ...
                <img src="/images/uploads/blog-detail.jpg"
                     alt=""/>
                <p>
                ...
                <p>It's a somewhat surprising, but welcome move, given that Whedon has taken a long break to write
                   ...
                   Batgirl, she's the superhero alias of Barbara Gordon, daughter of Gotham City Police Commissioner
                   James Gordon. So we can likely expect J.K. Simmons' take on Gordon to appear along with other
                   Bat-related characters.</p>
                ...
                <div className="flex-it flex-ct">
                    ...
                    <img src="/images/uploads/blog-detail2.jpg"
                         alt=""/>
                </div>
                ...
                <div className="comments">
                    ...
                    <div className="cmt-item flex-it">
                        <img src="/images/uploads/author.png"
                             alt=""/>
                        <div className="author-infor">
                            ...
                            <p><a className="rep-btn"
                                  href="#">+ Reply</a></p>
                        </div>
                    </div>
                    <div className="cmt-item flex-it reply">
                        <img src="/images/uploads/author2.png"
                             alt=""/>
                        <div className="author-infor">
                            <div className="flex-it2">
                                <h6><a href="#">Joss Whedon</a></h6>
                                <span className="time"> - 27 Mar 2017</span>
                            </div>
                    ...
                    <div className="cmt-item flex-it reply">
                        <img src="/images/uploads/author3.png"
                             alt=""/>
                        <div className="author-infor">
                            <div className="flex-it2">
                                <h6><a href="#">Dave McNary</a></h6>
                                <span className="time"> - 27 Mar 2017</span>
                            </div>
                    ...
                    <div className="cmt-item flex-it">
                        <img src="/images/uploads/author4.png"
                             alt=""/>
                        <div className="author-infor">
                            <div className="flex-it2">
