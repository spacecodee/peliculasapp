                            ...
                            <ul className="nav navbar-nav flex-child-menu menu-left">
                                ...
                                <li className="dropdown first">
                                    <a className="btn btn-default dropdown-toggle lv1"
                                       data-toggle="dropdown"
                                       data-hover="dropdown">
                                        movies<i className="fa fa-angle-down"
                                                 aria-hidden="true"></i>
                                    </a>
                                    <ul className="dropdown-menu level1">
                                        <li className="dropdown">
                                            <a href="#"
                                               ...
                                               data-toggle="dropdown">Movie
                                                                      grid<i className="ion-ios-arrow-forward"></i></a>
                                ...
                                <li className="dropdown first">
                                    <a className="btn btn-default dropdown-toggle lv1"
                                       data-toggle="dropdown"
                                       data-hover="dropdown">
                                        celebrities <i className="fa fa-angle-down"
    aria-hidden="true"/>
                                    </a>
                                    <ul className="dropdown-menu level1">
                                ...
                                <li className="dropdown first">
                                    <a className="btn btn-default dropdown-toggle lv1"
                                       data-toggle="dropdown"
                                       data-hover="dropdown">
                                        community <i className="fa fa-angle-down"
                                                     aria-hidden="true"></i>
                                    </a>
                                    <ul className="dropdown-menu level1">
                    ...
                    <div className="row ipad-width2">
                        <div className="col-md-8 col-sm-12 col-xs-12">
                            <div className="topbar-filter">
                                ...
                                <a href="movielist.html"
                                   className="list"><i className="ion-ios-list-outline active"/></a>
                                <a href="moviegrid.html"
                                   className="grid"><i className="ion-grid"/></a>
                            </div>
                        ...
                        <div className="col-md-4 col-sm-12 col-xs-12">
                            <div className="sidebar">
                                ...
                                <div className="ads">
                                    <img src="../public/images/uploads/ads1.png"
                                         alt=""/>
                                </div>
            ...
            <footer className="ht-footer">
                <div className="container">
                    <div className="flex-parent-ft">
                        ...
                        <div className="flex-child-ft item5">
                            ...
                            <a href="#"
                               className="btn">Subscribe now <i className="ion-ios-arrow-forward"/></a>
                        </div>
                    </div>
                </div>
                <div className="ft-copyright">
                    ...
                    <div className="backtotop">
                        <p><a href="#"
                              id="back-to-top">Back to top <i className="ion-ios-arrow-thin-up"/></a></p>
                    </div>
                </div>
            </footer>
        </div>
